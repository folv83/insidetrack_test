...
public class UnitType_ {
	...
	public static volatile SingularAttribute<UnitType, Long> idUnitType;
	public static volatile SingularAttribute<UnitType, String> nameUnitType;
	
	public enum ListSortFieldEnum {

		ID_UNIT_TYPE("idUnitType", "idUnitType"),
		NAME_UNIT_TYPE("nameUnitType", "nameUnitType");
