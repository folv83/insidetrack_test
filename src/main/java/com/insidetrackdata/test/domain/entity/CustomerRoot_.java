...
@StaticMetamodel(CustomerRoot.class)
public class CustomerRoot_ {

	public static volatile SingularAttribute<CustomerRoot, Long> idCustomerRoot;
	public static volatile SingularAttribute<CustomerRoot, String> nameCustomerRoot;
	
	public enum ListSortFieldEnum {

		ID_CUSTOMER_ROOT("idCustomerRoot", "idCustomerRoot"),
		NAME_CUSTOMER_ROOT("nameCustomerRoot", "nameCustomerRoot");
